...
<!-- CSS here -->
<link rel="stylesheet" type="text/css" href="{{ url('public/tenants/banca/css/elegant-icons.min.css') }}" media="all" />

<link rel="stylesheet" type="text/css" href="{{ url('public/tenants/banca/css/nice-select.css') }}" media="all" />
<link rel="stylesheet" type="text/css" href="{{ url('public/tenants/banca/css/default.css') }}" media="all" />
<link rel="stylesheet" type="text/css" href="{{ url('public/tenants/banca/css/responsive.css') }}" media="all" />


<link rel="stylesheet" type="text/css" href="{{ url('public/tenants/banca/build/css/intlTelInput.css') }}" />
...
@endsection
    ...
    <div class="col-12 p-3">
        ...
        {{-- <div class="page-content"> --}}
            ...
            <div class="container-fluid p-5">
                ...
                <div class="row">
                    <div class="my-3 p-3">
                        <h2 class="fw-normal">{{ Auth::user()->f_name .' '.  Auth::user()->l_name}}</h2>
                        <div class="">
                            <p>Please fill in this information for validation. After confirmation of your information submitted, your documents will be processed and will be validated within 24 hours.</p>
                        </div>
                        ...
                        <input id="application_main_id" type="hidden" value="{{ $getPersonalDetails == null ? "" : $getPersonalDetails->id }}">
                        ...
                        <div class="loan-details-widget">
                            ...
                            <form action="{{ url('tenant/personal_info_form') }}" method="POST" id="personal_info_form">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-6">
                                        <label class="label" for="gendersaa">Gender*</label>
                                        <div class="dob d-flex">
                                            <select class="form-select" id="gendersaa" name="gender" aria-label="Default select example">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="dob d-flex">
                                            <select class="form-select me-2" id="dob_day" name="dob_day">
                                            ...
                                            <select class="form-select me-2" id="dob_month" name="dob_month">
                                            ...
                                            <select class="form-select me-0" id="dob_year" name="dob_year">
                                    ...
                                    <div class="col-md-12">
                                        <label class="label" for="how_heard">How did you hear about us?</label>
                                        <div class="dob d-flex">
                                ...
                                <div class="row  mt-60">
                                    <div class="col-md-12">
                                        <div class="nav-btn d-flex justify-content-end">
                                            <button id="personal_info_form_btn" class=" theme-btn-primary_alt theme-btn next-btn" type="submit">Save & Continue <i class="ri-save-3-line"></i></button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="loan-details-widget">
                            ...
                            <form action="{{ url('tenant/emergency_contact_form')}}" method="POST" id="emergency_contact_form">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-md-12">
                                        <label class="label" for="emer_relationship">Relationship*</label>
                                        <div class="dob d-flex">
                                            <select class="form-select" id="emer_relationship" name="emer_relationship" class="emer_relationship">
                                ...
                                <div class="row  mt-60">
                                    <div class="col-md-12">
                                        <div class="nav-btn d-flex justify-content-end">
                                            <button class=" theme-btn-primary_alt theme-btn next-btn" type="submit">Save & Continue <i class="ri-save-3-line"></i></button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-9" id="p_info_employment" style="display: none">
                        ...
                        <div class="loan-details-widget">
                            ...
                            <form action="{{ url('tenant/employment_form')}}" method="POST" id="employment_form">
                                ...
                                <div class="row gy-4">
                                    <div class="col-md-12">
                                        <label class="label" for="employ_status">Current Employment Status*</label>
                                        <div class="dob d-flex">
                                            <select class="form-select" id="employ_status" name="employ_status">
                        ...
                        <div class="loan-details-widget">
                            ...
                            <form action="{{ url('tenant/document_verification_form')}}" id="document_verification_form" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-lg-12 col-md-6">
                                        <label class="label" for="employer_name">Name of Employer/Business*</label>
                                    ...
                                    <div class="col-lg-12 col-md-6">
                                        <label class="label" for="employer_address">Office Address of Employer/Business Location*</label>
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <label class="label" for="proof_of_doc_file">Proof of Employment/Business Operation (PDF/DOC/JPG/PNG)*</label>
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <label class="label" for="id_card_file">Proof of Identity (Ghana Card (JPG)/PNG)*</label>
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <label class="label" for="doc_Id_veri_display_img">Financial Statement (Pay Slip, Bank/MoMo)</label>
                                        <div class="card">
                                            <div class="card-body p-0">
                                    ...
                                    <div class="col-12">
                                        <div class="doc-info">
                                            <div class="row">
                                                ...
                                                <i class="h5 text-danger">Please make sure you have filled every neccessary detail before taking your selfie. 
                                                    Failure to do so disqualifies your application for the rent assistance.</i>
        ...
        <div class="modal fade" id="photoModal" tabindex="-1" aria-labelledby="photoModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                <form action="{{ url('tenant/document_selfie_form')}}" id="document_selfie_form" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="modal-header">
                    <h1 class="modal-title fs-5" id="photoModalLabel">Capture Photo</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        
                        <p class="h6 text-danger">After you have captured the photo, be sure before submiting the form. After submitting this form you won't be able to make any changes.</p>
                        <div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="theme-btn-primary_alt theme-btn mx-auto" id="takephoto">Capture Photo</button>
                        <button type="button" class="theme-btn-primary_alt theme-btn mx-auto d-none" id="retakephoto">Retake</button>
                        <button type="submit" class="theme-btn-primary_alt theme-btn mx-auto d-none" id="uploadphoto">Submit Forms</button>
    ...
    <script src="{{ url('public/tenants/assets/js/tenants_pers_info.js') }}"></script>

    <script src="{{ url('public/assets/js/make_payments.js') }}"></script>
        
    <script type="text/javascript" src="{{ url('public/tenants/banca/js/jquery.smoothscroll.min.js') }}"></script>
    <script type="text/javascript" src="{{ url('public/tenants/banca/js/jquery.waypoints.min.js') }}"></script>
    <script type="text/javascript" src="{{ url('public/tenants/banca/js/jquery.counterup.min.js') }}"></script>
    <script type="text/javascript" src="{{ url('public/tenants/banca/js/jquery.nice-select.min.js') }}"></script>
    <script type="text/javascript" src="{{ url('public/tenants/banca/js/wow.min.js') }}"></script>
    <script type="text/javascript" src="{{ url('public/tenants/banca/js/custom.js') }}"></script>


    <script src="{{ url('public/tenants/banca/build/js/intlTelInputWithUtils.js') }}"></script>

    <script src="{{ url('public/tenants/plugin/sweetalert/sweetalert.min.js') }}"></script>
    <script src="{{ url('public/tenants/plugin/webcamjs/webcam.min.js') }}"></script>
    <script src="{{ url('public/tenants/main.js') }}"></script>
    ...
    <script>
        ...
        inputs.forEach(input => {
            ...
            loadUtilsOnInit: "https://cdn.jsdelivr.net/npm/intl-tel-input@24.6.0/build/js/utils.js", // leading slash (and http-server) required for this to work in chrome
