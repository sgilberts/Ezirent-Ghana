@extends('admin.layouts.app')
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                                ...
                                                <div class="col-6 text-end">
                                                    <p class="text-muted mb-0 text-truncate">Total Applications</p>
                                ...
                                <div class="card overflow-hidden">
                                    <div class="card-body">
                                        <div class="row">
                                                ...
                                                <div class="col-6 text-end">
                                                    <p class="text-muted mb-0 text-truncate">Onboard Customers</p>
                                ...
                                <div class="card overflow-hidden">
                                    <div class="card-body">
                                        <div class="row">
                                                ...
                                                <div class="col-6 text-end">
                                                    <p class="text-muted mb-0 text-truncate">Approved Properties</p>
                                ...
                                <div class="card overflow-hidden">
                                    <div class="card-body">
                                        <div class="row">
                                                ...
                                                <div class="col-6 text-end">
                                                    <p class="text-muted mb-0 text-truncate">Defaulting Customers</p>
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                                ...
                                                <td>29 April 2024</td>
                                                <td>
                                                    <img src="{{ url('public/admins/assets/images/products/product-1(1).png') }}" alt="product-1(1)" class="img-fluid avatar-sm">
                                                </td>
                                                <td>
                                        ...
                                        <tr>
                                                ...
                                                <td>25 April 2024</td>
                                                <td>
                                                    <img src="{{ url('public/admins/assets/images/products/product-4.png') }}" alt="product-4" class="img-fluid avatar-sm">
                                                </td>
                                                <td>
                                        ...
                                        <tr>
                                                ...
                                                <td>25 April 2024</td>
                                                <td>
                                                    <img src="{{ url('public/admins/assets/images/products/product-5.png') }}" alt="product-5" class="img-fluid avatar-sm">
                                                </td>
                                                <td>
                                        ...
                                        <tr>
                                                ...
                                                <td>21 April 2024</td>
                                                <td>
                                                    <img src="{{ url('public/admins/assets/images/products/product-6.png') }}" alt="product-6" class="img-fluid avatar-sm">
                                                </td>
                                                <td>
                                        ...
                                        <tr>
                                                ...
                                                <td>18 April 2024</td>
                                                <td>
                                                    <img src="{{ url('public/admins/assets/images/products/product-1(2).png') }}" alt="product-1(2)" class="img-fluid avatar-sm">
                                                </td>
                                                <td>
    ...
    @section('script')
        ...
        <!-- Dashboard Js -->
        <script src="{{ url('public/admins/assets/js/pages/dashboard.js') }}"></script>
