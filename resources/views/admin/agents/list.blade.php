                                  ...
                                  <tbody>
                                    ...
                                    @foreach ($getAllAgents as $agent)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                  ...
                                                  <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                       <img src="{{ $agent->getUserImage() }}" alt="{{ $agent->f_name }}" class="avatar-md">
                                                  </div>
                                            ...
                                            <td>{{ $agent->phone }}</td>
                                            <td>
                                                  <div class="form-check form-switch" id="user_status_div_{{ $agent->id }}">
                                                       <input class="form-check-input user_status_btn" data-data_id="{{ $agent->id }}" type="checkbox" role="switch" id="flexSwitchCheckChecked1" {{ $agent->status == 1 ? 'checked' : '' }} >
                                                  </div>
                                             </td>
                                            <td>{{ Carbon::parse($agent->created_at)->toDayDateTimeString() }}</td>
                                            <td>
                                                <div class="d-flex gap-2">
                                                  
                                                    {{-- <a href="{{ url('admin/property_detail', $agent->prop_id) }}" class="btn btn-light btn-sm"><iconify-icon icon="solar:eye-broken" class="align-middle fs-18"></iconify-icon></a> --}}
                                                  
                                                    <a href="javascript:void(0);" class="btn btn-soft-danger btn-sm delete_user_btn" data-data_id="{{ $agent->id }}" data-user_page="agents" title="Delete Application"><iconify-icon icon="solar:trash-bin-minimalistic-2-broken" class="align-middle fs-18"></iconify-icon></a>
                                                </div>
                                            </td>
                                        </tr>
