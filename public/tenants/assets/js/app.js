! function(n) {
    ...
    function t(e) {
        1 == n("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (n("html").removeAttr("dir"), n("#dark-mode-switch").prop("checked", !1), n("#rtl-mode-switch").prop("checked", !1), n("#bootstrap-style").attr("href", "../public/tenants/assets/css/bootstrap.min.css"), n("#app-style").attr("href", "../public/tenants/assets/css/app.min.css"), document.documentElement.setAttribute("data-bs-theme", "light"), sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == n("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ? (n("html").removeAttr("dir"), n("#light-mode-switch").prop("checked", !1), n("#rtl-mode-switch").prop("checked", !1), n("#bootstrap-style").attr("href", "../public/tenants/assets/css/bootstrap.min.css"), n("#app-style").attr("href", "../public/tenants/assets/css/app.min.css"), document.documentElement.setAttribute("data-bs-theme", "dark"), sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == n("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e && (n("#light-mode-switch").prop("checked", !1), n("#dark-mode-switch").prop("checked", !1), n("#bootstrap-style").attr("href", "../public/tenants/assets/css/bootstrap-rtl.min.css"), n("#app-style").attr("href", "../public/tenants/assets/css/app-rtl.min.css"), n("html").attr("dir", "rtl"), document.documentElement.setAttribute("data-bs-theme", "light"), sessionStorage.setItem("is_visited", "rtl-mode-switch"))
    }
