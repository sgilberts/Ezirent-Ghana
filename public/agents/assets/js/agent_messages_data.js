...
$(document).ready(function () {
    ...
    function loadRepliedMessages() {
        ...
        $.ajax({
            url: 'get_all_agent_replied_messages',
            method: 'GET',
            dataType: 'json',
            async: false,
            // data: 'id',
    ...
    function readOpenMessages() {
        ...
        for (let index = 0; index < myDatas.length; index++) {
            ...
            <div class="offcanvas-body p-0 h-100" data-simplebar>
                ...
                <!-- start Snow-editor-->
            <div class="p-3">
                <form action="{{ url('agent_reply_message_form') }}" method="POST"  id="agent_reply_message_form">
                    @csrf
                    <div class="d-flex">
                        <img class="me-2 rounded-circle avatar-sm" src="../public/uploads/users/${myDatas[index].user_img}" alt="Generic placeholder image">
                        <div class="flex-grow-1">
    ...
    // Submit Message
    $("body").on("submit", "#agent_reply_message_form", function (e) {
        e.preventDefault();
